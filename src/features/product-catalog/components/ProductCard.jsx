...
export default function ProductCard({ product }) {
  ...
  return (
    <article
      ...
      <h3 className="text-lg font-bold md:text-xl xl:text-2xl" data-testid="product-name">{name}</h3>
      <div className="flex w-full flex-wrap items-center justify-between gap-2">
        <span className="text-lg font-semibold text-blue-600" data-testid="product-price">${price}</span>
        <span className="text-lg text-gray-600" data-testid="product-brand">{brand}</span>
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-2">
        ...
        <span className="text-sm text-gray-600" data-testid="product-category">{category}</span>
      </div>
    </article>
  );
}
